...
export default function DarkLoadingPage({ title = "Loading" }: { title?: string }) {
  ...
  useEffect(() => {
    ...
    // Simulate progress for demo purposes — replace with real progress updates if available
          ...
          <CardContent className="p-6 md:p-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-zinc-400 mt-1">Hang tight — we&apos;re setting things up for you.</p>
              </div>
            ...
            <div className="mt-6 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" className="px-3 py-1 text-sm" onClick={() => setProgress(100)}>
                  Skip
                </Button>
